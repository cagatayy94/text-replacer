        ...
        <div class="container">
            <div class="row justify-content-center text-center">
                <div class="alert alert-warning">
                    <strong>Dikkat</strong> Bağlantının iletilmesi bazen 15-20 dakikayı bulabilmektedir. Email gelen kutunuzu ve spam klasörünü kontrol etmeyi unutmayınız.
                </div>
                <div class="col-md-8 col-lg-6">
                    ...
                    <div style="display: none;" class="alert alert-success alert-success-div">
                        <strong>Başarılı!</strong> Size bir rapola sıfırlama epostası gönderdik lütfen mail kutunuzu kontrol ediniz.
                    </div>
                    <div style="display: none;" class="alert alert-warning alert-success-div">
                        E-posta elinize ulaşmadıysa: <br> 1.Spam klasörünü kontrol ediniz. <br> 2.Girdiğiniz e-posta adresini kontrol ediniz.<br>3. Eğer hala e-posta elinize ulaşmadıysa tekrar deneyiniz.
                    </div>
